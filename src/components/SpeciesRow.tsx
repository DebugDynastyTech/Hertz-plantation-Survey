...
interface Props {
  speciesList: any[];
  species: string; planted: string; survival: string; height: string;
...
export default function SpeciesRow({
  speciesList, species, planted, survival, height,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.pickerBox}>
        <Picker selectedValue={species} onValueChange={onSpeciesChange} style={styles.pickerInner}>
